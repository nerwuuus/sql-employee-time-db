...
Error 'Permission denied' while uploading data. Paste the code below in pgAdmin4, PSQL Tool to load data manually:
  \copy bronze.ess_mnp FROM 'C:\Users\(...)\OneDrive - (...)\Desktop\mnp.csv' WITH (FORMAT csv, HEADER true, DELIMITER ';', ENCODING 'UTF8');
  \copy bronze.ess_inm FROM 'C:\Users\(...)\OneDrive - (...)\Desktop\inm.csv' WITH (FORMAT csv, HEADER true, DELIMITER ';', ENCODING 'UTF8');
